...
const DepthText = ({
  ...
  return (
    <span ref={rootRef} className={`inline-block overflow-visible ${className}`.trim()} style={rootStyle}>
      <span ref={stageRef} className="relative inline-grid place-items-center overflow-visible" style={stageStyle}>
